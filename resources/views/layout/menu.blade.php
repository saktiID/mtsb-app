...
@if (Auth::user()->role == 'Admin')
    ...
    <x-menu-dropdown menuTitle="Database" menuIcon="database" menuParent="database" menuActive="admin/database/*">
        ...
        <x-sub-menu-dropdown menuTitle="Data Periode" menuRoute="data-periode"
            menuActive="admin/database/data-periode" />
        <x-sub-menu-dropdown menuTitle="Data Terhapus" menuRoute="data-terhapus"
            menuActive="admin/database/data-terhapus" />

    </x-menu-dropdown>

    <x-menu-dropdown menuTitle="Agenda Admin" menuIcon="paperclip" menuParent="agenda-admin"
        menuActive="admin/agenda/*">

        <x-sub-menu-dropdown menuTitle="Assessment Aspect" menuRoute="assessment-aspect"
...
@if (Auth::user()->role == 'Guru' || Auth::user()->role == 'Admin')
    ...
    @if ($menuAgenda && $menuAgenda->walas_id == Auth::user()->id)
        <x-menu-item menuTitle="Kelas Saya" menuIcon="columns" menuRoute="kelas-saya" menuActive="kelas-saya"
            altActive="guru/kelas-saya/*" />

        <x-menu-dropdown menuTitle="Agenda" menuIcon="paperclip" menuParent="agenda" menuActive="guru/agenda/*">
            <x-sub-menu-dropdown menuTitle="Teacher Assessment" menuRoute="teacher-assessment"
                menuActive="guru/agenda/teacher-assessment" />
            <x-sub-menu-dropdown menuTitle="Assessment History" menuRoute="assessment-history.guru"
...
@if (Auth::user()->role == 'Siswa')
    ...
    <x-menu-dropdown menuTitle="Agenda" menuIcon="paperclip" menuParent="agenda" menuActive="siswa/agenda/*">
        ...
        <x-sub-menu-dropdown menuTitle="Parent Assessment" menuRoute="parent-assessment"
            menuActive="siswa/agenda/parent-assessment" />
        <x-sub-menu-dropdown menuTitle="Peer Assessment" menuRoute="peer-assessment"
            menuActive="siswa/agenda/peer-assessment" />
        <x-sub-menu-dropdown menuTitle="Self Assessment" menuRoute="self-assessment"
            menuActive="siswa/agenda/self-assessment" />
        <x-sub-menu-dropdown menuTitle="Assessment History" menuRoute="assessment-history.siswa"
            menuActive="siswa/agenda/assessment-history" />
...
@section('modal_logout')
    <div class="modal fade" id="logoutModal" role="dialog" data-backdrop="static" data-keyboard="false"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="{{ route('logout') }}" type="submit" id="btn-logout" class="btn btn-danger loadingTriggerLogout">Tetap
                            keluar</a>
                </div>
            </div>
        </div>

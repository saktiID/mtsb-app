            ...
            <div class="col-lg-8 col-sm-12">
                ...
                <form method="POST" id="data_guru" class="mb-4" data-form="data_guru">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-sm-12">
                            <div class="mb-3">
                                <label for="gender">Gender guru *</label>
                        ...
                        <div class="col-lg-6 col-sm-12">
                            <div class="mb-3">
                                ...
                                <input type="tel" placeholder="6285xxxxx" value="{{ $user->guru->telp }}" name="telp" id="telp" class="form-control" required>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-sm-12">
                            <div class="mb-3 field-wrapper">
                                <label for="password-confirmation">Konfirmasi password guru</label>

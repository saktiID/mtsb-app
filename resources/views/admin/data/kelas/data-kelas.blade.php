                        ...
                        <div class="form-row">
                            <div class="col-lg-12 col-sm-12">
                                <div class="alert alert-light-warning">
                                    <span>Detail Kelas | Periode: Semester {{ $periodeAktif->semester }}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-sm-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" value="" id="bagian_kelas" name="bagian_kelas"
                                                class="form-control" placeholder="contoh: A" required>
                                        </div>
                                    </div>
                                </div>
                            </div>

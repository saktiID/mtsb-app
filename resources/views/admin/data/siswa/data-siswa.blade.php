    ...
    <div class="row pt-4">
        ...
        <x-card-box cardTitle="Data Siswa">
            <div class="btn-group mb-3" role="group" aria-label="Basic example">
                ...
                <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#tambahModal">Tambah
                    siswa</button>
                <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#uploadModal">Upload
                    excel</button>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-lg-6 col-sm-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" value="" id="nis" name="nis" class="form-control"
                                        required>
                                </div>

                                <div class="mb-3">
                                    <label for="nama">Nama *</label>
                                    <input type="text" value="" id="nama" name="nama" class="form-control"
                                        required>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="tel" value="" id="telp" name="telp" class="form-control"
                                        required>
                            ...
                            <div class="col-lg-6 col-sm-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" value="" id="nisn" name="nisn"
                                        class="form-control">
                                </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col d-flex justify-content-end">
                            <a href="{{ route('download-template') }}" class="btn btn-warning btn-sm">Download
                                template</a>
                        </div>
                    </div>

    ...
    <div class="row pt-4">
        ...
        <x-card-box cardTitle="Assessment Aspects">
            <div class="alert alert-warning" role="alert">
                ...
                Membuat assessment aspect baru untuk peer assessment juga akan diterapkan untuk self assessment!
            </div>
            ...
            <ul class="nav nav-tabs  mb-3" id="lineTab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="teacher-aspect-tab" data-toggle="tab" href="#teacher-link" role="tab"
                        aria-selected="true">Teacher </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="parent-aspect-tab" data-toggle="tab" href="#parent-link" role="tab"
                        aria-selected="false">Parent </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="peer-aspect-tab" data-toggle="tab" href="#peer-link" role="tab"
                        aria-selected="false">Peer </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="self-aspect-tab" data-toggle="tab" href="#self-link" role="tab"
                        aria-selected="false">Self </a>
                </li>
            </ul>

            <div class="tab-content" id="lineTabContent-3">
                <div class="tab-pane fade show active" id="teacher-link" role="tabpanel"
                    aria-labelledby="teacher-aspect-tab">
                ...
                <div class="tab-pane fade" id="self-link" role="tabpanel" aria-labelledby="peer-aspect-tab">
                    <div class="table-responsive">
                        <table id="aspect_self" class="table table-striped table-hover" style="width:100%">
                            <thead>
                                <tr class="text-center">
                                    <th>No</th>
                                    <th data-priority="1">Aspect</th>
...
@section('script')
    ...
    <script>
        ...
        function onfinish() {
            ...
            $('#aspect_self').DataTable().ajax.reload()

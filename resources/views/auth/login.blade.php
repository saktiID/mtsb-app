...
@section('content')
    <style>
        /* Auth */
        .form-container {
            background-image: url('/assets/img/bg-10-2025.png');
                ...
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <div class="avatar avatar-xl">
                            <a href="">
                                <img src="{{ asset('logo.png?v=' . now()) }}" alt="logo" class="rounded-circle"
                                    height="90px" width="90px">
                            </a>
                        </div>

                        <h3 class="text-white">MTsB App</h3>
                        <span class="text-white">MTs Bilingual Muslimat NU Pucang Sidoarjo</span>
                            ...
                            <div class="form">
                                ...
                                <div id="username-field" class="field-wrapper input">
                                    ...
                                    <input id="username" name="username" type="text" class="form-control"
                                        placeholder="cth: @username/nis" value="{{ old('username') }}">
                                    @error('username')
                                ...
                                <div id="password-field" class="field-wrapper input">
                                    ...
                                    <input id="password" name="password" type="password" class="form-control"
                                        placeholder="Kata sandi" autocomplete="on">
                                ...
                                <div class="n-chk mb-3">
                                    <label class="new-control new-checkbox new-checkbox-rounded checkbox-primary">
                                        ...
                                        <span class="new-control-indicator"></span> <span class="text-white">Ingat
                                            saya</span>
                                    </label>
                                </div>

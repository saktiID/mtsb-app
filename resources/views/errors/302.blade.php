...
<body class="error404 text-center">
        ...
        <div class="row">
            <div class="col-md-4 mr-auto mt-5 text-md-left text-center">
                <a href="index.html" class="ml-md-5">
                    <img alt="image-404" src="{{ asset('logo.png') }}" class="theme-logo">
                </a>
            </div>
        </div>
    </div>
    <div class="container-fluid error-content">
        <div class="">
            <h1 class="error-number" hidden>302</h1>
            <p class="mini-text">Ooops!</p>
            <img src="{{ asset('assets/img/not-found.png') }}" width="70%" style="max-width: 400px" alt="not found">
            <p class="error-text mb-4 mt-1">Yahh, Kamu belum dimasukkan kelas di periode ini 🥲 <br> Tenang! infokan aja ke walas kamu.</p>

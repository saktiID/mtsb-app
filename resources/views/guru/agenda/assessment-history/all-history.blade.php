                ...
                success: function(response) {
                    ...
                    let result = $('#history').DataTable({
                        buttons: [{
                            ...
                            filename: `${document.getElementById('assessment_for').     value}_Assessment_{{ $kelas }}_${document.getElementById('bulan').value}_minggu_${document.getElementById('minggu_ke').value}`,

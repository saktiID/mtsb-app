                ...
                <div class="col-lg-4 col-sm-12 mb-4">
                    <div class="text-center">
                        <div class="avatar avatar-xl mb-4">
                            <img alt="foto" id="foto" src="{{ route('get-foto', '-') }}" width="250px" height="250px"
                                ...
                                <td>
                                    <select id="siswa_kelas" name="siswa_kelas" class="form-control">
                                        ...
                                        @foreach ($siswaDalamKelas as $siswa)
                                            <option
                                                value="{{ $siswa->user->id }}/{{ $siswa->user->avatar }}/{{ $siswa->siswa->nis }}/{{ $siswa->user->nama }}">
                                                {{ $siswa->user->nama }}</option>
                                        @endforeach
                                    </select>
                                </td>
                            </tr>
